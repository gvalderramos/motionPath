...
elseif(APPLE)
    ...
    set(MAYA_LIB_SUFFIX "devkit/include")
...
find_path(MAYA_INCLUD_DIR maya/MFn.h
    PATHS
        ${MAYA_LOCATION}
        $ENV{MAYA_VERSION}
    PATH_SUFFIXES
...
set(_MAYA_LIBRARIES OpenMaya OpenMayaAnim OpenMayaFX OpenMayaRender OpenMayaUI Foundations)
foreach(MAYA_LIB ${_MAYA_LIBRARIES})
    find_library(MAYA_${MAYA_LIB}_LIBRARY NAMES ${MAYA_LIB} PATHS ${MAYA_LIBRARY_DIR} NO_DEFAULT_PATH)
    set(MAYA_LIBRARIES ${MAYA_LIBRARY} ${MAYA_${MAYA_LIB}_LIBRARY})
endforeach()
